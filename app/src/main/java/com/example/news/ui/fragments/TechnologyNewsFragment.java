...
public class TechnologyNewsFragment extends Fragment implements NewsRVAdapter.OnTapListener {
    ...
    public void initialize(){
        if(mainViewModel.checkNetworkState(getContext())){
            ...
            // 6th
                ...
                mainViewModel.getNewsOfCategory("technology");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mainViewModel.repository.getTechnologyNews().observe(getViewLifecycleOwner(),  new Observer<List<NewsArticle>>() {
            @Override
    ...
    public void OpenUrl(String url) {
        ...
        intent.putExtra("tab_name", "Technology");
