...
public class ScienceNewsFragment extends Fragment implements NewsRVAdapter.OnTapListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_espn_news, container, false);
    ...
    public void initialize(){
        if(mainViewModel.checkNetworkState(getContext())){
            ...
            cardViewNoInternet.setVisibility(View.GONE);
                ...
                mainViewModel.getNewsOfCategory("science");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mainViewModel.repository.getScienceNews().observe(getViewLifecycleOwner(),  new Observer<List<NewsArticle>>() {
            @Override
    ...
    public void OpenUrl(String url) {
        ...
        intent.putExtra("tab_name", "Science");
