...
public class HealthNewsFragment extends Fragment implements NewsRVAdapter.OnTapListener {
    ...
    public void initialize(){
        if(mainViewModel.checkNetworkState(getContext())){
            ...
            cardViewNoInternet.setVisibility(View.GONE);
                ...
                mainViewModel.getNewsOfCategory("health");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mainViewModel.repository.getHealthNews().observe(getViewLifecycleOwner(),  new Observer<List<NewsArticle>>() {
            @Override
    ...
    public void OpenUrl(String url) {
        ...
        intent.putExtra("tab_name", "Health");
